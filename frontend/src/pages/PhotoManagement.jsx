      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          {sliderImages.map((image) => (
            <div key={`slider-image-${image.id}`} className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
...
const TeamMemberSection = ({ 
  ...
  <div className="space-y-6">
    ...
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
        <div className="flex-1 min-w-0">
          <h3 className="text-lg font-medium truncate" style={{ color: '#29add3' }}>Add New Team Member</h3>
          <p className="text-sm text-gray-700 mt-1">Upload a photo and fill in team member details</p>
        </div>
        <button
        ...
        <div className="mt-4 bg-gray-50 rounded-lg p-4 border border-gray-200">
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center bg-gray-50">
            ...
            {uploading && (
              <div className="mt-2 flex items-center justify-center">
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-blue-600 mr-2"></div>
                <span className="text-xs text-gray-600">Uploading and creating team member...</span>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="px-4 sm:px-6 py-4 sm:py-6">
            {/* Success Alert */}
            {success && (
              <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-4 sm:mb-6">
                {success}
              </div>
            )}
            ...
            {/* Tabs */}
            <div className="border border-gray-200 rounded-lg mb-4 sm:mb-8">
              ...
              <div className="p-4 sm:p-6">
                ...
                {tab.id === 'homepageslider' ? (
                  ...
                  <FacilitySection 
                    ...
                    handleDeleteFacility={confirmDeleteFacility}
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 relative">
              ...
              <div className="p-6">
                <p className="text-gray-700 mb-4">
                  ...
                  <span className="font-semibold text-gray-900">"{deleteData.name}"</span>?
                </p>
                <p className="text-sm text-gray-500">
                  This action cannot be undone. The {deleteData.type === 'team' ? 'team member' : deleteData.type === 'slider' ? 'slider image' : 'facility photo'} will be permanently removed.
                </p>
              </div>
