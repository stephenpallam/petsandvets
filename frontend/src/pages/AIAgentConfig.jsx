      ...
      if (agentType === 'time_sheet') {
        ...
        if (activeTab === 'sms-scheduled') {
          agentData = {
            ...
            sms_link: smsScheduledMode.smsLink,
          ...
          agentData = {
            ...
            sms_link: smsRecurringMode.smsLink,
            ...
            selected_sms_customer: smsRecurringMode.selectedCustomer,
        ...
        agentData = {
          ...
          ...(marketingMode.channels.includes('social_media') && {
            marketing_social_platforms: marketingMode.socialPlatforms
          }),
                    ...
                    {(() => {
                      ...
                      if (isRunMode) {
                        return agentType === 'time_sheet' ? 'Run Timesheet AI Agent' : 
                               agentType === 'sms_agent' ? 'Run SMS AI Agent' :
                               agentType === 'marketing_agent' ? 'Run Marketing AI Agent' : 'Run Social Media AI Agent';
                      } else if (isEditMode) {
                        return agentType === 'time_sheet' ? 'Edit Timesheet AI Agent' : 
                               agentType === 'email' ? 'Edit Email AI Agent' :
                               agentType === 'sms_agent' ? 'Edit SMS AI Agent' :
                               agentType === 'marketing_agent' ? 'Edit Marketing AI Agent' : 'Edit Social Media AI Agent';
                      } else {
                        return agentType === 'time_sheet' ? 'Create New Timesheet Agent' : 
                               agentType === 'email' ? 'Create New Email Agent' :
                               agentType === 'sms_agent' ? 'Create New SMS Agent' :
                               agentType === 'marketing_agent' ? 'Create New Marketing Agent' : 'Create New Social Media Agent';
                      }
                    })()}
                  </h2>
                                  ...
                                  searchedCustomers.map((customer) => (
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setSearchedCustomers([]);
                                        setEmailWriteMode(prev => ({ ...prev, selectedCustomer: customer.id, customerName: getCustomerFullName(customer) }));
                                      }}
                    ...
                    {searchParams.get('agent_type') === 'sms_agent' ? (
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <input
                            type="url"
                            value={smsScheduledMode.smsLink}
                            onChange={(e) => setSmsScheduledMode(prev => ({ ...prev, smsLink: e.target.value }))}
                            placeholder="https://petsandvetsanimalhospital.com"
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            This link will be included in your SMS messages. Use [LINK] placeholder in your template above.
                          </p>
                        </div>
                          ...
                          {smsScheduledMode.smsType === 'single' && (
                            <div className="space-y-3">
                              ...
                              <div>
                                ...
                                {/* Search Results */}
                                {customerSearchTerm.length >= 3 && !isSearchingCustomers && (
                                  <div className="border border-gray-300 rounded-lg max-h-40 overflow-y-auto mt-2">
                                    {searchedCustomers.length > 0 ? (
                                      searchedCustomers
                                        ...
                                        .map((customer) => (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setCustomerSearchTerm(getCustomerFullName(customer));
                                              setSearchedCustomers([]);
                                              setSmsScheduledMode(prev => ({ ...prev, selectedCustomer: customer.id, customerName: getCustomerFullName(customer) }));
                                            }}
                                            className="p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-b-0"
                                          >
                                            <div className="font-medium text-gray-900">{getCustomerFullName(customer)}</div>
                                      ...
                                      <div className="p-3 text-gray-500 text-center">
                                        No customers with phone numbers found matching "{customerSearchTerm}"
                                      </div>
                                    )}
                                  </div>
                                )}
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          setSelectedCustomer(null);
                                          setCustomerSearchTerm('');
                                          setSmsScheduledMode(prev => ({ ...prev, selectedCustomer: null, customerName: '' }));
                                        }}
                                        className="text-green-600 hover:text-green-800"
                                      >
                                        <X className="h-5 w-5" />
                          ...
                          <div className="space-y-3">
                            ...
                            <label className="flex items-start">
                              <input
                                ...
                                name="smsScheduledPostDestination"
                                value="auto_send"
                                checked={smsScheduledMode.postDestination === 'auto_send'}
                                onChange={(e) => setSmsScheduledMode(prev => ({ ...prev, postDestination: e.target.value }))}
                                className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                              />
                              <div className="ml-3">
                                <span className="text-sm font-medium text-gray-900">Send Immediately</span>
                                <p className="text-xs text-gray-600">SMS is sent immediately on holidays without manual review</p>
                              </div>
                            </label>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-end space-x-3">
                          <button
                            onClick={isRunMode ? saveAndRunAgent : saveAgent}
                            disabled={loading || (!isEditMode && !isRunMode && (!smsScheduledMode.agentName || smsScheduledMode.selectedHolidays.length === 0 || !smsScheduledMode.smsContentTemplate || (smsScheduledMode.smsType === 'single' && !smsScheduledMode.selectedCustomer)))}
                            className="text-white px-6 py-2 rounded-lg transition-colors disabled:opacity-50 flex items-center font-medium"
                            style={{ 
                              backgroundColor: loading ? '#94a3b8' : 
                                            isRunMode ? '#10b981' : '#29add3'
                            ...
                            onMouseEnter={(e) => {
                              if (!loading && ((isEditMode || isRunMode) || (smsScheduledMode.agentName && smsScheduledMode.selectedHolidays.length > 0 && smsScheduledMode.smsContentTemplate && (smsScheduledMode.smsType === 'bulk' || smsScheduledMode.selectedCustomer)))) {
                                e.target.style.backgroundColor = isRunMode ? '#059669' : '#1e88e5';
                              }
                            }}
                            onMouseLeave={(e) => {
                                        ...
                                        .map((customer) => (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setCustomerSearchTerm(getCustomerFullName(customer));
                                              setSearchedCustomers([]);
                                              setSmsWriteMode(prev => ({ ...prev, selectedCustomer: customer.id, customerName: getCustomerFullName(customer) }));
                                            }}
                                            className="p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-b-0"
                                          >
                                            <div className="font-medium text-gray-900">{getCustomerFullName(customer)}</div>
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          setSelectedCustomer(null);
                                          setCustomerSearchTerm('');
                                          setSmsWriteMode(prev => ({ ...prev, selectedCustomer: null, customerName: '' }));
                                        }}
                                        className="text-green-600 hover:text-green-800"
                                      >
                                        <X className="h-5 w-5" />
                    ...
                    {searchParams.get('agent_type') === 'sms_agent' ? (
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <TemplateDropdown
                            templates={smsTemplates}
                            selectedValue={smsRecurringMode.smsContentTemplate}
                            onSelect={(templateContent) => {
                              if (templateContent.length <= 160) {
                                setSmsRecurringMode(prev => ({ ...prev, smsContentTemplate: templateContent }));
                              }
                            }}
                            placeholder="Select an SMS template..."
                            templateType="sms"
                        ...
                        <div>
                          ...
                          <input
                            type="url"
                            value={smsRecurringMode.smsLink}
                            onChange={(e) => setSmsRecurringMode(prev => ({ ...prev, smsLink: e.target.value }))}
                            placeholder="https://petsandvetsanimalhospital.com"
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                          <p className="text-xs text-gray-500 mt-1">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label className="flex items-center p-4 bg-gray-50 rounded-lg border cursor-pointer hover:bg-gray-100">
                              <input
                                type="checkbox"
                                checked={smsRecurringMode.smsType === 'bulk'}
                                onChange={(e) => {
                                  if (e.target.checked) {
                                    setSmsRecurringMode(prev => ({ ...prev, smsType: 'bulk', selectedCustomer: null }));
                                  }
                                }}
                                className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-3"
                              />
                            ...
                            <label className="flex items-center p-4 bg-gray-50 rounded-lg border cursor-pointer hover:bg-gray-100">
                              <input
                                type="checkbox"
                                checked={smsRecurringMode.smsType === 'single'}
                                onChange={(e) => {
                                  if (e.target.checked) {
                                    setSmsRecurringMode(prev => ({ ...prev, smsType: 'single' }));
                                  }
                                }}
                                className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-3"
                              />
                          ...
                          {smsRecurringMode.smsType === 'single' && (
                            <div className="space-y-3">
                              <div className="p-3 bg-blue-50 rounded-lg">
                                <div className="flex items-start">
                                  <User className="h-4 w-4 text-blue-600 mt-0.5 mr-2" />
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          setSelectedCustomer(null);
                                          setCustomerSearchTerm('');
                                          setSmsRecurringMode(prev => ({ ...prev, selectedCustomer: null, customerName: '' }));
                                        }}
                                        className="text-green-600 hover:text-green-800"
                                      >
                                        <X className="h-5 w-5" />
                  ...
                  {marketingMode.channels.includes('sms') && (
                    <div className="mt-4 p-4 bg-purple-50 rounded-lg">
                      ...
                      <div>
                        <TemplateDropdown
                          templates={smsTemplates}
                          selectedValue={marketingMode.smsTemplate}
      ...
      {showFullScreenEditor && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
            {/* Modal Header */}
            <div className="px-6 py-4 rounded-t-xl flex-shrink-0" style={{ backgroundColor: 'rgb(41, 173, 211)' }}>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Mail className="h-6 w-6 text-white" />
                  <h2 className="text-xl font-semibold text-white">{fullScreenEditorTitle}</h2>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="hidden sm:flex items-center space-x-2 text-sm text-white text-opacity-90">
                    <kbd className="px-2 py-1 bg-white bg-opacity-20 rounded text-xs text-white">Ctrl+S</kbd>
                    <span>to save</span>
                    <kbd className="px-2 py-1 bg-white bg-opacity-20 rounded text-xs text-white">Esc</kbd>
                    <span>to close</span>
                  </div>
                  <button
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full h-80 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-sm font-mono resize-none"
                      style={{ '--tw-ring-color': 'rgb(41, 173, 211)' }}
...
[BUSINESS_ADDRESS] - Business address"
                ...
                <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-cyan-900 mb-2">💡 Email Template Tips:</h4>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                    ...
                    <div className="bg-white p-2 rounded border">
                      <code style={{ color: 'rgb(41, 173, 211)' }}>[BOOK_NOW_LINK]</code>
            ...
            {/* Modal Footer */}
            <div className="px-6 py-4 border-t border-gray-200 rounded-b-xl flex-shrink-0">
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-500">
                  {fullScreenEditorContent.length} characters
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => e.target.style.backgroundColor = 'rgb(35, 147, 180)'}
