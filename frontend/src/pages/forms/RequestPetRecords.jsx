        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{ paddingTop: '40px', paddingBottom: '40px' }}>
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">
              Request Pet Records Form
            </h1>
          </div>
          <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Use this form to request copies of your pet's medical records for transfers, second opinions, or personal records.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-xl">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-blue-900 mb-2">Record Request Information</h3>
                  <div className="text-blue-700 space-y-1">
                    <p>• Valid photo ID required for pickup</p>
                    <p>• Processing typically takes 1-3 business days</p>
                    <p>• Specify date range and record types needed</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 border-2 border-purple-200 p-6 rounded-xl">
              <div className="flex items-start">
                <Shield className="h-6 w-6 text-purple-600 mt-0.5 mr-3 flex-shrink-0" />
                <div>
                  <h3 className="text-lg font-bold text-purple-900 mb-2">Privacy & Security</h3>
                  <div className="text-purple-700 space-y-1">
                    <p>• Only authorized individuals can request records</p>
                    <p>• Records are securely handled and transmitted</p>
                    <p>• May require additional authorization for transfers</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href="https://petsandvetsanimalhospital.com/forms/Request_Pet_Records_Form.pdf"
                    target="_blank"
                  ...
                  <a
                    href="https://petsandvetsanimalhospital.com/request-pet-records-form"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="relative">
              <iframe
                src="https://petsandvetsanimalhospital.com/request-pet-records-form"
                width="100%"
                height="800"
                style={{ border: 0, minHeight: '800px' }}
                title="Request Pet Records Form"
                loading="lazy"
              ></iframe>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700 mb-4">
                If you have questions about requesting records or need assistance with this form, please call us.
              </p>
              <a
...
export default RequestPetRecords;