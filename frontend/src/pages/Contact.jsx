...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="text-white sticky z-40 block md:hidden" style={{ top: '7.2rem', background: `linear-gradient(135deg, ${primaryColor} 0%, #2196c7 100%)`, paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
