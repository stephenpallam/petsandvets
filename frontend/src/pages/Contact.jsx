      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            {/* Placeholder for second column (can be used for additional info) */}
            <div className="space-y-8">
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a href={`tel:${hospitalInfo.phone}`} className="font-semibold" style={{ color: primaryColor }}>
                      {hospitalInfo.phone}
                    </a>
                  </div>
                  <div className="flex items-center">
                    <Mail className="h-5 w-5 mr-3" style={{ color: primaryColor }} />
                    <a href={`mailto:${hospitalInfo.email}`} className="font-semibold" style={{ color: primaryColor }}>
                      {hospitalInfo.email}
                    </a>
                  </div>
                  <div className="flex items-start">
                    <MapPin className="h-5 w-5 mr-3 mt-1" style={{ color: primaryColor }} />
