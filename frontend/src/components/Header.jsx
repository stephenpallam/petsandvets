                  ...
                  {item.dropdown ? (
                    ...
                    >
                      <button
                        ...
                        style={{
                          backgroundColor: (location.pathname.includes('/services') || location.pathname.includes('/urgent-care') || location.pathname.includes('/dog-') || location.pathname.includes('/cat-') || location.pathname.includes('/pet-') || location.pathname.includes('/dental-') || location.pathname.includes('/ultrasound-') || location.pathname.includes('/veterinary-') || location.pathname.includes('/digital-') || location.pathname.includes('/preventive-') || location.pathname.includes('/blocked-') || location.pathname.includes('/foreign-') || location.pathname.includes('/our-') || location.pathname.includes('/about') || location.pathname.includes('/gallery') || location.pathname.includes('/reach-us') || location.pathname.includes('/message-us') || location.pathname.includes('/contact') || location.pathname.includes('/forms')) ? '#e6f7fb' : 'transparent',
                          color: (location.pathname.includes('/services') || location.pathname.includes('/urgent-care') || location.pathname.includes('/dog-') || location.pathname.includes('/cat-') || location.pathname.includes('/pet-') || location.pathname.includes('/dental-') || location.pathname.includes('/ultrasound-') || location.pathname.includes('/veterinary-') || location.pathname.includes('/digital-') || location.pathname.includes('/preventive-') || location.pathname.includes('/blocked-') || location.pathname.includes('/foreign-') || location.pathname.includes('/our-') || location.pathname.includes('/about') || location.pathname.includes('/gallery') || location.pathname.includes('/reach-us') || location.pathname.includes('/message-us') || location.pathname.includes('/contact') || location.pathname.includes('/forms')) ? '#29add3' : undefined
                        }}
                        onMouseEnter={(e) => {
                          if (!location.pathname.includes('/services') && !location.pathname.includes('/urgent-care') && !location.pathname.includes('/dog-') && !location.pathname.includes('/cat-') && !location.pathname.includes('/pet-') && !location.pathname.includes('/dental-') && !location.pathname.includes('/ultrasound-') && !location.pathname.includes('/veterinary-') && !location.pathname.includes('/digital-') && !location.pathname.includes('/preventive-') && !location.pathname.includes('/blocked-') && !location.pathname.includes('/foreign-') && !location.pathname.includes('/our-') && !location.pathname.includes('/about') && !location.pathname.includes('/gallery') && !location.pathname.includes('/reach-us') && !location.pathname.includes('/message-us') && !location.pathname.includes('/contact') && !location.pathname.includes('/forms')) {
