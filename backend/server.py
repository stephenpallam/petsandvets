from fastapi import FastAPI, APIRouter, HTTPException, Depends, status, UploadFile, File, Header, Body, Query
...
async def get_business_info():
    ...
    if not business_info:
        ...
        default_info = BusinessInfo(
            ...
            address="43114 Peacock Market Plaza, Suite F110\nSouth Riding, VA 20152",
...
async def update_business_info(
    ...
    if not existing_info:
        ...
        new_info = BusinessInfo(
            ...
            address=business_data.address or "43114 Peacock Market Plaza, Suite F110\nSouth Riding, VA 20152",
...
async def generate_post_for_agent(agent_id: str, agent_data: dict):
    ...
    try:
        ...
        elif agent_type == AIAgentType.MARKETING_AGENT:
            # Handle marketing agent - generate multi-channel campaign
            return await generate_marketing_campaign_for_agent(agent_id, agent_data)
        else:
